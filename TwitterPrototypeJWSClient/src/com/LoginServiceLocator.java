...
public class LoginServiceLocator extends org.apache.axis.client.Service implements com.LoginService {
    ...
    private java.lang.String Login_address = "http://localhost:8080/TwitterPrototypeJWS/services/Login";
    ...
    public com.Login getLogin() throws javax.xml.rpc.ServiceException {
    ...
    public com.Login getLogin(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.LoginSoapBindingStub _stub = new com.LoginSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.Login.class.isAssignableFrom(serviceEndpointInterface)) {
                com.LoginSoapBindingStub _stub = new com.LoginSoapBindingStub(new java.net.URL(Login_address), this);
                _stub.setPortName(getLoginWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://com", "LoginService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://com", "Login"));
        }
